...
public class MailUtils {
    ...
    private static String username = "AfterJourneyBen@163.com"; // 邮箱账户
    private static String password = "Lc10369"; // 邮箱授权码

    private static String from = "AfterJourneyBen@163.com"; // 使用当前账户
